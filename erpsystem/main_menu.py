...
def CRM_module():  
    ...
    while True:
        ...
        CRM_ADD_CUSTOMER = Button(image=None, pos=(100, 500),
                            text_input="Add new customer", font=get_font(font_size), base_color="blue", hovering_color="white")
        CRM_ADD_CUSTOMER.change_Color(CRM_MOUSE_POS)
        CRM_ADD_CUSTOMER.update(SCREEN)

        CRM_BACK = Button(image=None, pos=(100, 580),
                            text_input="Back to main menu", font=get_font(font_size), base_color="black", hovering_color="white")
        CRM_BACK.change_Color(CRM_MOUSE_POS)
        CRM_BACK.update(SCREEN)

        CRM_REMOVE_CUSTOMER = Button(image=None, pos=(300, 500),
                            text_input="Remove customer", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        CRM_LIST_CUSTOMERS = Button(image=None, pos=(100, 520),
                            text_input="List customers", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        CRM_UPDATE_CUSTOMER = Button(image=None, pos=(500, 500),
                            text_input="Update customer", font=get_font(font_size), base_color="red", hovering_color="white")
        CRM_UPDATE_CUSTOMER.change_Color(CRM_MOUSE_POS)
        CRM_UPDATE_CUSTOMER.update(SCREEN)

        CRM_EMAIL = Button(image=None, pos=(350, 520),
                            text_input="Subscribed customer emails", font=get_font(font_size), base_color="red", hovering_color="white")
...
def SALES_module():
    while True:
        ...
        SALES_LIST_TRANS = Button(image=None, pos=(400, 50),
                            text_input="List transactions", font=get_font(font_size), base_color="blue", hovering_color="white")
        ...
        SALES_ADD_NEW_TRANS = Button(image=None, pos=(400, 100),
                            text_input="Add new transaction", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        SALES_REMOVE_TRANS = Button(image=None, pos=(400, 150),
                            text_input="Remove transaction", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        SALES_UPDATE_TRANS= Button(image=None, pos=(400, 200),
                            text_input="Update transaction", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        SALES_BIGGEST_REVENUE = Button(image=None, pos=(400, 250),
                            text_input="Get the transaction that made the biggest revenue", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        SALES_PRODUCT_BIGGEST_REVENUE = Button(image=None, pos=(400, 300),
                            text_input="Get the product that made the biggest revenue altogether", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        SALES_TRANSACTIONS_NUMER = Button(image=None, pos=(400, 350),
                            text_input="Count number of transactions between", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        SALES_TRANSACTIONS_PRICE = Button(image=None, pos=(400, 400),
                            text_input="Sum the price of transactions between", font=get_font(font_size), base_color="red", hovering_color="white")
...
def HR_module():
    while True:
        ...
        HR_ADD_EMPLOYEE = Button(image=None, pos=(400, 50),
                            text_input="Add new employees", font=get_font(font_size), base_color="blue", hovering_color="white")
        ...
        HR_REMOVE_EMPLOYEE = Button(image=None, pos=(400, 100),
                            text_input="Remove employee", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        HR_LIST_EMPLOYEE = Button(image=None, pos=(400, 150),
                            text_input="List employee", font=get_font(font_size), base_color="red", hovering_color="white")
        HR_LIST_EMPLOYEE.change_Color(HR_MOUSE_POS)
        HR_LIST_EMPLOYEE.update(SCREEN)

        HR_UPDATE_EMPLOYEE= Button(image=None, pos=(400, 200),
                            text_input="Update employee", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        HR_OLD_TO_YOUNG = Button(image=None, pos=(400, 250),
                            text_input="Oldest and youngest employees", font=get_font(font_size), base_color="red", hovering_color="white")
        HR_OLD_TO_YOUNG.change_Color(HR_MOUSE_POS)
        HR_OLD_TO_YOUNG.update(SCREEN)

        HR_AVERAGE_AGE = Button(image=None, pos=(400, 300),
                            text_input="Employees average age", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        HR_BIRTHDAY_NEXT_2WEEKS = Button(image=None, pos=(400, 350),
                            text_input="Employees with birthdays in the next two weeks", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        HR_CLEARANCE_LEVEL = Button(image=None, pos=(400, 400),
                            text_input="Employees with clearance level", font=get_font(font_size), base_color="red", hovering_color="white")
        ...
        HR_NUMBER_DEPARTMENT = Button(image=None, pos=(400, 450),
                            text_input="Employee numbers by department", font=get_font(font_size), base_color="red", hovering_color="white")
